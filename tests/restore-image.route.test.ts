...
describe('RestoreAI API', () => {
  ...
  it('should handle user prompt in restoration', async () => {
    ...
    // Check that the generateContent was called with a prompt that includes the user instructions
    expect(mockGenerateContent).toHaveBeenCalledWith(
      expect.arrayContaining([
        expect.stringContaining('Focus on restoring the facial features and removing scratches')
      ])
    )
  })
  ...
  it('should use default restoration type when not provided', async () => {
    ...
    // Check that the generateContent was called with a prompt that includes the default restoration type
    expect(mockGenerateContent).toHaveBeenCalledWith(
      expect.arrayContaining([
        expect.stringContaining('Restoration type: general')
      ])
    )
  })
  ...
  it('should refund credits when Gemini API call fails', async () => {
    ...
    // Check that credit refund was attempted
