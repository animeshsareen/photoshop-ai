  ...
  const handleGenerateGhibli = async () => {
    ...
    try {
      ...
      try {
        ...
        if (creditRes.ok) {
          const credJson = await creditRes.json()
          if (typeof credJson.credits === "number") {
                      ...
                      <div className="space-y-3">
                        <div className="grid grid-cols-2 gap-3">
                          <div className="relative aspect-square rounded-lg overflow-hidden bg-muted group">
                            <Image src={image.data} alt="Upload preview" fill className="object-cover" sizes="320px" />
                            <button
                              onClick={(e) => {
                                e.stopPropagation()
                                removeImage()
                  ...
                  {isProcessing && (
                    <div className="space-y-2 pt-1">
                      ...
                      <p className="text-xs text-muted-foreground text-center">
                        {remainingSeconds != null ? `${remainingSeconds}s remaining` : "Working..."}
                      </p>
                    </div>
                  )}
                </CardContent>
                  ...
                  {image ? (
                    ghibliUrl ? (
                      ...
                      <div className="relative aspect-square rounded-lg border border-dashed border-border bg-muted overflow-hidden">
                        <Image src={image.data} alt="Original image" fill className="object-cover" sizes="320px" />
